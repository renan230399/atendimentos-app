import { Patient, Form, FormResponse } from "../Patients/interfacesPatients";
...
interface PatientDetailsProps {
  ...
  forms: Form[];
  logo?: string;
  handleOpenAddFormPopup: (form: Form) => void;
            ...
            {forms.map((form) => (
              <div key={form.id} className="md:w-[100%] flex p-4 m-auto bg-gray-100 rounded-lg shadow border-b border-black">
                ...
                <div className="flex space-x-4">
                  <PrimaryButton
                    onClick={() => handleOpenAddFormPopup(form)}
