...
class ConsultationSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach (range(1, 1000) as $index) {
            ...
            Transaction::create([
                'account_id' => 1, // Exemplo de ID de conta (ajuste conforme necessário)
                ...
                'description' => "Receita de consulta para o paciente ID {$consultation->patient_id}", // Descrição com detalhes da consulta
